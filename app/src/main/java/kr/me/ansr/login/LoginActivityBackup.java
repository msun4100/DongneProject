...
//				final String password = "1234";
                ...
                NetworkManager.getInstance().postDongneLogin(LoginActivityBackup.this, email, password, new NetworkManager.OnResultListener<LoginInfo>() {
                    @Override
                    public void onSuccess(Request request, LoginInfo result) {
                        Toast.makeText(LoginActivityBackup.this, "result:" + result, Toast.LENGTH_SHORT).show();
//						Log.i("LoginInfo>>", result.toString());
...
//						PropertyManager.getInstance().setPassword(password);
                    ...
                    public void onFailure(Request request, int code, Throwable cause) {
                        Toast.makeText(LoginActivityBackup.this, "onFailure cause:" + cause, Toast.LENGTH_SHORT).show();
                    }
                });
            }
        });
